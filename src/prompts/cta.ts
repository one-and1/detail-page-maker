...
export function buildCtaPrompt(product: ProductInfo, tone: Tone): string {
  return [
    ...
    "- Create anticipation for the buyer's next moment rather than pushing the action itself.",
    "- Encourage the next action gently, without hard-selling.",
    "- Avoid pushy commands like buying right now.",
    "- The closing line should leave a small expectation, after-use image, or decision confidence.",
    "- The action line should feel low-pressure and calm, not urgent or transactional.",
    ...
    "- Prefer rhythm and expectation over formal explanatory endings.",
    ...
    "",
    getCategoryPromptRule(product, "cta"),
    "",
    getCommonCopyRules(),
    "",
    "Product context:",

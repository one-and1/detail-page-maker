...
export function buildUspPrompt(product: ProductInfo, tone: Tone): string {
  return [
    ...
    "- Turn product strengths into buyer-facing value that can be felt during real use.",
    "- Focus on what changes in the buyer's day: comfort, ease, fit, confidence, care, or decision clarity.",
    "- Let the selected tone decide whether that value is emotional, minimal, refined, or criteria-based.",
    ...
    "- Prefer concrete sensory or usage moments over explanatory verbs like provides, supports, improves, or enhances.",
    ...
    "",
    getCategoryPromptRule(product, "usp"),
    "",
    getCommonCopyRules(),
    "",
    "Product context:",
